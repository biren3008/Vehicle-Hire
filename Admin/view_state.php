<?php
	...
	$queryData = mysql_query("SELECT * FROM state") or die(mysql_error());
	
	include 'delete_state.php';
...
<div id="main_container">
	...
	<table id="rounded-corner" summary="2007 Major IT Companies' Profit">
        <thead>
            <tr>
                <th align="center" scope="col" class="rounded-company"></th>
                <th align="center" scope="col" class="rounded">State Id</th>
                <th align="center" scope="col" class="rounded">State</th>
                <th align="center" scope="col" class="rounded">Edit</th>
        ...
        <?php while ($row = mysql_fetch_assoc($queryData)){ ?>
            <tr>
                ...
                <td align="center"><?php echo $row['State Name'] ?></td>
                
                <td align="center">
	                <a href="">
                        <input type="image" name="edit" value="submit" src="images/user_edit.png" alt="submit Button" 
                        onMouseOver="this.src='images/user_edit.png'">
                	</a>
                </td>
                <td align="center">
                    <a href="">
