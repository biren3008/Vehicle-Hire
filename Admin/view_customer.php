<?php
	...
	$queryData = mysql_query("SELECT * FROM vhcustomer") or die(mysql_error());
	
	include 'delete_login_user.php';
...
<div id="main_container">
    ...
    <div class="left_content">    <!-- end of right content-->
	...
	<table id="rounded-corner" summary="2007 Major IT Companies' Profit">
      <thead>
    	<tr>
            ...
            <th scope="col" class="rounded" align="center">Email ID</th>
            <th scope="col" class="rounded" align="center">Password</th>            
            <th scope="col" class="rounded" align="center">Gender</th>
            <th scope="col" class="rounded" align="center">Address</th>
            <th scope="col" class="rounded" align="center">Mobile Number</th>                        
