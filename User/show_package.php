<?php
	...
	$queryData = mysql_query("SELECT * FROM showpackage") or die(mysql_error());
	    ...
	    <table width="979" id="rounded-corner" summary="2007 Major IT Companies' Profit">
            <thead>
                <tr>
                    ...
                    <th align="center" class="rounded" scope="col">package Type</th>
                    <th align="center" class="rounded" scope="col">Person</th>
                    <th align="center" class="rounded-q4" scope="col">Mobile Number</th>
                </tr>
            </thead>
            ...
            <?php while ($row = mysql_fetch_assoc($queryData)){ ?>
                <tr>
                    ...
                    <td align="center"><?php echo $row['Package Type'] ?></td>
